    ...
    <Layout>
      ...
      <div className="mt-8 bg-slate-900/50 border border-slate-800 p-6 rounded-xl">
        ...
        <p className="text-slate-400 text-sm">
            AR and AP aging provide decision context, but the deterministic reference forecast does not yet estimate collection probabilities. Any future weighting rule must be introduced as a versioned assumption and measured through frozen historical backtests.
        </p>
      </div>
    </Layout>
  );
