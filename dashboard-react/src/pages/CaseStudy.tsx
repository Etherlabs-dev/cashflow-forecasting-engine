      ...
      <div className="max-w-4xl mx-auto pb-20">
        ...
        <div className="text-center mb-16 pt-8">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
                A tested reference architecture for frozen forecasts, isolated scenarios, and historical comparison.
            </p>
        </div>
            ...
            <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800">
                <ul className="space-y-4 text-slate-300">
                    <li className="flex gap-3">
                        ...
                        <span><strong>Manual consolidation:</strong> Disconnected bank, receivable, payable, and payroll exports create slow and error-prone forecast inputs.</span>
                    </li>
                    <li className="flex gap-3">
                        <span className="text-rose-500 font-bold">•</span>
        ...
        <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
                <TechBlock 
                    ...
                    desc="Orchestrates ingestion, schedules, persistence, and notifications while deterministic finance rules remain independently testable."
                />
                <TechBlock 
                    icon={Database} 
                ...
                />
                 <TechBlock 
                    icon={Layers} 
                    title="Logic Layer" 
                    desc="A Python 3.11 package owns forecast, scenario, recurrence, currency, runway, alert, and backtest behavior."
                />
            </div>
            ...
            <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 overflow-x-auto">
                ...
                <div className="flex items-center justify-center min-w-[600px] text-xs font-mono text-slate-300 gap-2">
                    ...
                    <div className="p-4 border border-primary-500/50 rounded bg-primary-900/10 text-primary-300">
                        ...
                        1. Ingest<br/>2. Normalize<br/>3. Call tested engine
                    </div>
                    <ArrowRight className="text-slate-600" />
        ...
        {/* Value Prop */}
        <section className="mb-20">
             <h2 className="text-2xl font-bold text-white mb-6 border-l-4 border-primary-500 pl-4">Evidence</h2>
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 text-center">
                     <div className="text-3xl font-bold text-white mb-2">Tested</div>
                     <div className="text-sm text-slate-400">Deterministic finance behavior</div>
                 </div>
                 <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 text-center">
                     <div className="text-3xl font-bold text-white mb-2">Frozen</div>
                     <div className="text-sm text-slate-400">As-of dates and assumptions</div>
                 </div>
                 <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 text-center">
                     <div className="text-3xl font-bold text-white mb-2">Synthetic</div>
                     <div className="text-sm text-slate-400">Backtest mechanics measured</div>
                 </div>
             </div>
        </section>
        ...
        <section className="text-center bg-gradient-to-b from-slate-900 to-slate-950 p-12 rounded-2xl border border-slate-800">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://github.com/Etherlabs-dev/cashflow-forecasting-engine" className="px-6 py-3 bg-white text-slate-900 font-bold rounded-lg hover:bg-slate-200 transition-colors flex items-center justify-center gap-2">
                    View on GitHub <ArrowRight size={18} />
                </a>
                <a href="https://github.com/Etherlabs-dev/cashflow-forecasting-engine/blob/main/docs/09-evidence.md" className="px-6 py-3 bg-slate-800 text-white font-medium rounded-lg hover:bg-slate-700 transition-colors border border-slate-700">
